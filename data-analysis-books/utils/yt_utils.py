...
def extract_video_details(video):
    ...
    response['channel_title'] = video['snippet']['channelTitle']
    response['channel_id'] = video['snippet']['channelId']
    response['category_id'] = video['snippet']['categoryId']
...
def get_video_details(video_id):
    ...
    response = extract_video_details(video)
